# A.P.A V2 - Advanced Personal Assistant
...
> **A.P.A** = **A**dvanced **P**ersonal **A**ssistant

APA V2 is a sophisticated AI assistant designed for multimodal interaction. It combines Google's Gemini 2.5 Native Audio with computer vision, gesture control, and 3D CAD generation in a Electron desktop application.
...
```bash
# 1. Clone and enter
git clone https://github.com/nazirlouis/apa_v2.git && cd apa_v2

# 2. Create Python environment (Python 3.11)
conda create -n apa_v2 python=3.11 -y && conda activate apa_v2
...
# 5. Run!
conda activate apa_v2 && npm run dev
```
...
2. Type this command and hit Enter:
   ```bash
   git clone https://github.com/nazirlouis/apa_v2.git
   ```
3. This creates a folder named `apa_v2`.

**Step 5: Open in VS Code**
1. Open VS Code.
2. Go to **File > Open Folder**.
3. Select the `apa_v2` folder you just downloaded.
...
```bash
conda create -n apa_v2 python=3.11
conda activate apa_v2
...
3. Drag and drop this file into the `apa_v2/backend` folder.
...
4. Create a file named `.env` in the `apa_v2` folder (same level as `README.md`).
...
You have two options to run the app. Ensure your `apa_v2` environment is active!

### Option 1: The "Easy" Way (Single Terminal)
The app is smart enough to start the backend for you.
1. Open your terminal in the `apa_v2` folder.
2. Activate your environment: `conda activate apa_v2`
3. Run:
   ```bash
   npm run dev
   ```
...
**Solution**:
1. Make sure your `.env` file is in the root `apa_v2` folder (not inside `backend/`).
...
│   ├── apa.py                  # Gemini Live API integration
