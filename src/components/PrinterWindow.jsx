...
const PrinterWindow = ({
    ...
    return (
        <div
            ...
            ${activeDragElement === 'printer' ? 'ring-2 ring-cyan-400' : ''}`}
            style={{
                left: position.x,
                top: position.y,
        ...
        >
            ...
            <div className="h-10 bg-white/5 border-b border-white/10 flex items-center justify-between px-4 shrink-0 backdrop-blur-md">
                <span className="text-xs font-bold tracking-widest text-emerald-300 flex items-center gap-2">
                    <Printer size={12} /> 3D PRINTERS
                </span>
